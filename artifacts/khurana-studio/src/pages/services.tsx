...
export const ServicesPage = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useListServices({ query: { queryKey: getListServicesQueryKey() } });
        ...
        <div className="container mx-auto px-6 md:px-12">
          <FadeIn className="text-center mb-20">
            ...
            <p className="font-sans text-muted-foreground max-w-2xl mx-auto font-light">
              We offer comprehensive visual storytelling services across multiple disciplines,
              maintaining our signature editorial approach in every frame.
            </p>
          </FadeIn>

          {isError ? (
            <div className="text-center py-24 flex flex-col items-center gap-6">
              <p className="font-sans text-muted-foreground">Failed to load services. Please try again.</p>
              <button
                onClick={() => refetch()}
                      ...
                      <div className="w-full md:w-1/2 relative overflow-hidden">
                        <FadeIn direction={index % 2 === 1 ? "left" : "right"}>
                          <div className="aspect-[4/3] relative overflow-hidden">
                            <div className="absolute inset-0 bg-black/10 z-10 transition-colors group-hover:bg-transparent duration-700 pointer-events-none" />
                            <ImageWithFallback
                              ...
                              objectFit="cover"
                              loading="lazy"
                              className="w-full h-full transform scale-100 group-hover:scale-105 transition-transform duration-1000 ease-out"
                            />
                          </div>
                        </FadeIn>
                      </div>
                        ...
                        <FadeIn direction="up" delay={0.2}>
                          ...
                          {service.startingPrice && (
                            <div className="mb-8 font-sans text-sm tracking-wide text-foreground">
                              ...
                              <span className="font-medium text-studio-silver ml-2">
                                {service.startingPrice}
                              </span>
                            </div>
                          )}
